  ...
  if (contactForm) {
    ...
    function showFieldError(field, message) {
      ...
      if (!errorEl) {
        ...
        errorEl.id = field.id ? field.id + '-error' : 'error-' + Math.random().toString(36).slice(2);
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      if (!isValid) {
        ...
        const formError = contactForm.querySelector('.form-submit-error') || (function () {
        ...
        formError.textContent = contactForm.dataset.errorGeneral || 'Please correct the errors above and try again.';
        return;
      }

      const existingError = contactForm.querySelector('.form-submit-error');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '613cd1bd-8402-4b91-bc16-ceaba166cae3',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '613cd1bd-8402-4b91-bc16-ceaba166cae3';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '613cd1bd-8402-4b91-bc16-ceaba166cae3';
